...
const BUBBLE_DENSITY = 100; //100, 50 -Над полученной анимацией можно экспериментировать, меняя размеры, плотность пузырьков, цвета.
//если уменьшить плотность пузырьков до 50 (константа BUBBLE_DENSITY), а их размер сделать от 3 до 9 (свойство size класса Bubble)
...
class Bubble {
   ...
   init() {
       ...
       this.size = generateDecimalBetween(3, 9); // (1, 3) ; (3, 9);
